...
from messageing.views import mynotificationsviews,NotificationDeleteView,AllNotificationDeleteView
...
urlpatterns = [
    ...
    path('notification/delete/', AllNotificationDeleteView.as_view()),
]