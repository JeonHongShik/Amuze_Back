...
class UserManager(BaseUserManager):
    def create_user(self, Uidd, name, password=None):
        user = self.model(Uidd=Uidd, name=name)
        user.set_password(password)
        user.save(using=self._db)
        return user

    def create_superuser(self, Uidd, name, password):
        user = self.create_user(Uidd=Uidd, name=name, password=password)
        user.is_staff = True
